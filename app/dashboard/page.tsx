...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100/80">
      {/* Header */}
      <header className="sticky top-0 z-50 border-b border-gray-200/60 bg-gradient-to-r from-white/90 via-white/80 to-blue-50/80 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          {/* Left: Logo & Brand */}
          <Link href="/" className="flex items-center gap-3 group">
            <div className="relative">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center shadow-md shadow-blue-600/20 group-hover:shadow-lg group-hover:shadow-blue-600/30 transition-all duration-300">
            ...
            <div>
              ...
              <p className="text-[11px] font-medium text-blue-600/70 leading-tight">
                AI-Powered Newsroom
              </p>
            </div>
          </Link>
          ...
          {/* Center: Status Badge */}
          <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-full bg-gray-100/80 border border-gray-200/60">
            <div className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse" />
            <span className="text-xs font-medium text-gray-600">Agent Ready</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/"
              className="inline-flex items-center gap-1.5 text-sm font-medium text-gray-500 hover:text-gray-900 transition-all rounded-xl px-4 py-2 hover:bg-white/80 border border-transparent hover:border-gray-200 hover:shadow-sm"
            >
